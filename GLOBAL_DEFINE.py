...
def app_init():
    ...
    if not paras_json:
        ...
        DEFAULT_CORE_QUANTITY = int(paras_json.get('DEFAULT_CORE_QUANTITY', DEFAULT_CORE_QUANTITY))
        LOG_DIR = paras_json.get('LOG_DIR', LOG_DIR)
        JACKETT_API_LINK_LIST = paras_json.get('JACKETT_API_LINK_LIST', JACKETT_API_LINK_LIST)
        ERROR_RETRY_SPAN = int(paras_json.get('ERROR_RETRY_SPAN', ERROR_RETRY_SPAN))
        FILTER_DICTS = paras_json.get('FILTER_DICTS', FILTER_DICTS)
    return CONFIG_PATH,DB_PATH ,ARIA2_RPC_SERVER,ARIA2_JSONRPC_TOKEN,DEFAULT_CORE_QUANTITY,LOG_DIR,JACKETT_API_LINK_LIST,ERROR_RETRY_SPAN,FILTER_DICTS
